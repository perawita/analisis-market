                    ...
                    <h4 class="mb-3">Value Margin of Safety (MoS) of {{ isset($symbol) ? strtoupper($symbol) : '' }}</h4>
                        <div class="row gy-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="eps" value={{$results['eps']}} readonly>
                            </div>

                            <div class="col-md-3">
                                <label for="growth_rate" class="form-label">Growth rate prjection</label>
                                <input type="text" class="form-control" id="growth_rate" value={{$results['growth_rate']}} readonly>
                            </div>
